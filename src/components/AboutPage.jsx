...
<Section alt>
  <Container style={{ 
    ...
    <Fade direction="left">
      ...
      Rehoboth Dunkemo Integrated Services and Energy Ltd was incorporated as private limited company in 25th of May, 2022 in Federal Republic of Nigeria as an integrated solutions and development company dedicated to  advancing sustainable communities through the productive use of renewable energy and climate-smart agricultural systems. Our work combines clean energy technologies, modern agricultural practices, engineering expertise and collaborative partnerships to address critical development challenges including energy access, food security, job creation and environmental sustainability. We design and implement practical solutions that improve livelihoods while supporting long-term economic and ecological resilience. Operating at the intersection of energy and agriculture, we support communities, institutions and enterprises with systems that power farms, enable agro-processing, improve productivity and reduce dependence on fossil fuels. Our approach emphasizes local participation, knowledge transfer and capacity building to ensure that projects remain sustainable beyond implementation. We partner with government agencies, development organizations, private sector stakeholders and local communities to deliver impactful initiatives that promote inclusive growth and responsible resource management.
      </TextBlock>
    </Fade>
